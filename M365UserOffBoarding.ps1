<#
365 User offboarding

Original script by Admindroid- edited by Ollie
#>
param(
[string]$TenantId,
[string]$ClientId,
...
#made changes to this function to only remove accounts and not wipe entire device
{
    if($MailBoxAvailability -eq 'No')
    {
    ...
    try{
        ...
        $MobileDevice| Clear-MobileDevice -accountonly -Confirm:$False 
